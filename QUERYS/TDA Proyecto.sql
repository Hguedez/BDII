...
CREATE OR REPLACE TYPE Datos_basicos_personas AS OBJECT(
    primer_nombre varchar2(15),
    segundo_nombre varchar2(15),
    primer_apellido varchar2(15),
    segundo_apellido varchar2(15),
    fecha_nacimiento date,
    STATIC FUNCTION validar_primer_nombre(primer_nombre varchar2) RETURN varchar2,
    STATIC FUNCTION validar_segundo_nombre(segundo_nombre varchar2) RETURN varchar2,
    STATIC FUNCTION validar_primer_apellido(primer_apellido varchar2) RETURN varchar2,
    STATIC FUNCTION validar_segundo_apellido(segundo_apellido varchar2) RETURN varchar2,
